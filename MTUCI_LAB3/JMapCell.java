...
public class JMapCell extends JComponent {
    private static final Dimension CELL_SIZE = new Dimension(12, 12);  // Устанавливаем размер каждой ячейки!
    ...
    private void updateAppearance() {
        if (passable) {
            ...
            if (endpoint)  // Стартовая/конечная точка
                setBackground(Color.CYAN);
            else if (path)  // Постоенный путь
