...
public class Lab1 {
    ...
    public static double computeArea(Point3d obj1, Point3d obj2, Point3d obj3) {
        ...
        if (a + b > c && a + c > b && a + c > b) {  // Проверяем условие существование треугольника!
        ...
        return Math.sqrt(p * (p - a) * (p - b) * (p - c));
            ...
            System.out.println("The triangle with this coordinates - does not exist");  // Если треугольник не существует, то выводим сообщение и 0
            return 0;
        }
    }
}
